...
exports.InsertHotel = function(name,phone,city,address,type, image ,money ,number,callback) {
    var  addSql2 = 'INSERT INTO t_hotel(name,phone,city,address,type, image ,money ,number) VALUES(?,?,?,?,?,?, ? , ?)';
    var  addSqlParams2 = [name,phone,city,address,type, image ,money ,number];
